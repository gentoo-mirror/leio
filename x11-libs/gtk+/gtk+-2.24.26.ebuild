...
multilib_src_install_all() {
	...
	# Provide gtk-update-icon-cache via gtk+:3
	if use gtk3-only ; then
		rm -v "${ED}"usr/bin/gtk-update-icon-cache
		rm -v "${ED}"usr/share/gtk-doc/html/gtk2/gtk-update-icon-cache.html
	fi
